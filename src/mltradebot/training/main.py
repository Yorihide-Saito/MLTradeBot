...
使い方:
  ...
  python -m mltradebot.training.main --trials 50
...
from mltradebot.training.data_fetcher import HistoricalDataFetcher
from mltradebot.training.model_evaluator import ModelEvaluator
from mltradebot.training.pipeline import RetrainPipeline
...
def main() -> None:
    ...
    if args.binance:
        from mltradebot.training.binance_data_fetcher import BinanceDataFetcher
